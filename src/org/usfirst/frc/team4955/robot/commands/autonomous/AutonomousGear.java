...
import org.usfirst.frc.team4955.robot.commands.autonomous.vision.ApprocheTarget;
...
public class AutonomousGear extends CommandGroup {
	...
	public AutonomousGear() {
		...
		addSequential(new ApprocheTarget(VisionState.Gear, 28, Constants.VISION_GEAR_CENTER_OFFSET));
